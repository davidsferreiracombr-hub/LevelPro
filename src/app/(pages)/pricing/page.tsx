    ...
    <div className="space-y-16">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {contacts.map((contact, index) => (
          <Card key={index} className="bg-card/70 border border-border/50 hover:border-accent hover:bg-card/90 transition-all duration-300 flex flex-col text-center">
