    ...
    <div className="relative">
      ...
      <div className="relative z-20 container mx-auto px-4 pt-20 sm:pt-32 pb-12">
        ...
        <div className="text-center mt-16">
          <Button asChild size="lg" className="h-10 sm:h-11 bg-white text-black hover:bg-white/90 transition-transform duration-300 hover:scale-105 shadow-[0_0_15px_rgba(255,255,255,0.5)] hover:shadow-[0_0_25px_rgba(255,255,0.7)] uppercase px-6 sm:px-8">
              <Link href="/pricing">
                  Continuar
              </Link>
          </Button>
