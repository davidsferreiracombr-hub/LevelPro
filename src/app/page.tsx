          ...
          <div className="relative z-20">
            ...
            <section id="nossos-servicos" className="relative pb-24 sm:pb-32 pt-10 sm:pt-20">
              <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold mb-6 sm:mb-8 text-foreground text-center uppercase">NOSSOS SERVIÇOS</h2>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-fit mx-auto">
                  {games.map((game) => (
                    <Link href={game.href} key={game.name} className="group block w-32 sm:w-36">
