          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {infoBarItems.map((item, index) => (
                <div
                  key={index}
                  className="relative overflow-hidden rounded-2xl p-4 text-center flex flex-col items-center group transition-all duration-300 bg-zinc-900/50 border border-zinc-800 hover:border-accent/30"
                >
          ...
          <div className="container mx-auto px-4 space-y-12">
            ...
            <div className="flex justify-center">
              <div className="relative w-full max-w-sm md:max-w-4xl bg-gradient-to-br from-zinc-950/70 to-black/70 backdrop-blur-lg border border-white/10 rounded-2xl shadow-2xl overflow-hidden group">
                <div className="absolute -top-1/2 -left-1/3 w-[600px] h-[600px] bg-primary/20 rounded-full filter blur-3xl opacity-0 group-hover:opacity-50 transition-opacity duration-700"></div>
                <div className="absolute -bottom-1/2 -right-1/3 w-[600px] h-[600px] bg-accent/20 rounded-full filter blur-3xl opacity-0 group-hover:opacity-50 transition-opacity duration-700 [animation-delay:500ms]"></div>
                ...
                <div className="relative p-4 md:p-8 flex flex-col md:flex-row items-center gap-4 md:gap-10">
                  <div className="flex-shrink-0">
                      <Image
                          ...
                          width={200}
                          height={200}
                          className="w-28 h-28 md:w-48 md:h-48 rounded-full object-cover border-4 border-white/10 shadow-2xl shadow-black transition-transform duration-500 group-hover:scale-105"
                  ...
                  <div className="flex-grow text-center md:text-left">
                      ...
                      <p className="text-foreground/60 text-sm mt-1 md:mt-3">{desktopContact.bio}</p>
                      ...
                      <Button asChild size="lg" className="w-full mt-4 md:mt-8 bg-accent text-accent-foreground hover:bg-accent/90 font-bold text-base rounded-lg transition-all duration-300 shadow-[0_0_20px_hsl(var(--accent)_/_0.7)] hover:shadow-[0_0_30px_hsl(var(--accent)_/_1)] group-hover:scale-105">
