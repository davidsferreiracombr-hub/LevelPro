  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center">
      <div className="container mx-auto px-4">
        <div className="relative mt-4 flex h-16 items-center justify-center md:justify-between rounded-full border border-border/50 bg-background/80 px-6 backdrop-blur-sm shadow-lg">
